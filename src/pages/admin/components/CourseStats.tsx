...
const CourseStats: React.FC<CourseStatsProps> = ({ stats }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-5 gap-4 mb-6">
      <div className="bg-white rounded-[1.2rem] p-4 border border-gray-200">
        <div className="text-2xl font-bold text-hyper-yellow">{stats.total}</div>
      ...
      <div className="bg-white rounded-[1.2rem] p-4 border border-gray-200">
        <div className="text-2xl font-bold text-cobalt">{stats.aiPractice}</div>
