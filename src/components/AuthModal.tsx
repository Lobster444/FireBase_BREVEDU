              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-[1.2rem] text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 transition-colors ${
                      errors.name 
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 bg-white border rounded-[1.2rem] text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 transition-colors ${
                    errors.password 
                      ? 'border-red-400 focus:border-red-400 focus:ring-red-400/20' 
                      : 'border-gray-300 focus:border-cobalt focus:ring-cobalt/20'
                  }`}
