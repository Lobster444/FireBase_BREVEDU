...
/**
 * PillToggleButton - Headspace-style pill toggle for category filters
 * 
 * Usage:
 * <PillToggleButton
 *   label="All"
 ...
 *   active={selectedCategory === 'Guided meditations'}
 *   onClick={() => setSelectedCategory('Guided meditations')}
 *   disabled={loading}
 * />
 */
