...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="hero-headspace w-full py-16 sm:py-20 lg:py-24 text-center relative overflow-hidden">
          ...
          <div className="text-center lg:text-left space-y-8">
            <h1 className="hero-title text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] tracking-tight">
              {userMessage.title.includes('Just 5 Minutes') ? (
                <>
                  ...
                  <span className="block text-[#002fa7] mt-2 lg:mt-3 drop-shadow-sm">Just 5 Minutes</span>
                </>
              ) : (
                userMessage.title
              )}
            </h1>
            <p className="hero-subtitle text-lg sm:text-xl lg:text-2xl max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal text-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start pt-4">
              {!currentUser ? (
                <>
                  <AccentButton 
                    className="hero-cta-primary px-8 py-4 text-lg font-semibold min-w-[200px] shadow-lg hover:shadow-xl transition-all duration-300"
