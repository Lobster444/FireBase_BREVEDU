...
const CourseModal: React.FC<CourseModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        ref={modalRef}
        className="bg-primary border border-neutral-gray/30 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-neutral-gray/20">
          <div>
            <h2 id="modal-title" className="text-h2 text-text-light">
          ...
          <button
            onClick={onClose}
            className="text-neutral-gray hover:text-text-light transition-colors p-2 rounded-lg hover:bg-neutral-gray/20"
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              {/* Title */}
              <div>
                <label htmlFor="title" className="block text-small font-medium text-text-light mb-2">
                  Course Title *
                </label>
                <input
                  ref={firstInputRef}
                  ...
                  className={`w-full px-4 py-3 bg-neutral-gray/20 border rounded-lg text-text-light placeholder-neutral-gray focus:outline-none focus:ring-2 transition-colors ${
                    errors.title 
                ...
                />
                {errors.title && (
                  <p id="title-error" className="mt-1 text-small text-red-400 flex items-center space-x-1">
              ...
              {/* Description */}
              <div>
                <label htmlFor="description" className="block text-small font-medium text-text-light mb-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className={`w-full px-4 py-3 bg-neutral-gray/20 border rounded-lg text-text-light placeholder-neutral-gray focus:outline-none focus:ring-2 transition-colors resize-vertical ${
                    errors.description 
                      ? 'border-red-400 focus:border-red-400 focus:ring-red-400/20' 
                      : 'border-neutral-gray/30 focus:border-accent-yellow focus:ring-accent-yellow/20'
                  }`}
                ...
                />
                {errors.description && (
                  <p id="description-error" className="mt-1 text-small text-red-400 flex items-center space-x-1">
                    <AlertCircle className="h-4 w-4" />
              ...
              {/* Video URL */}
              <div>
                <label htmlFor="videoUrl" className="block text-small font-medium text-text-light mb-2">
                  YouTube Video URL *
                </label>
                <input
                  type="url"
                ...
                />
                {errors.videoUrl ? (
                  <p id="videoUrl-error" className="mt-1 text-small text-red-400 flex items-center space-x-1">
                    <AlertCircle className="h-4 w-4" />
                    <span>{errors.videoUrl}</span>
                  </p>
                ) : (
                  <p id="videoUrl-help" className="mt-1 text-x-small text-neutral-gray">
              ...
              {/* Thumbnail URL */}
              <div>
                <label htmlFor="thumbnailUrl" className="block text-small font-medium text-text-light mb-2">
                  Thumbnail Image URL *
                </label>
                <input
                  type="url"
                ...
                />
                {errors.thumbnailUrl && (
                  <p id="thumbnailUrl-error" className="mt-1 text-small text-red-400 flex items-center space-x-1">
                    <AlertCircle className="h-4 w-4" />
              ...
              {/* Duration */}
              <div>
                <label htmlFor="duration" className="block text-small font-medium text-text-light mb-2">
                  Duration *
                </label>
                <input
                  type="text"
                ...
                />
                {errors.duration ? (
                  <p id="duration-error" className="mt-1 text-small text-red-400 flex items-center space-x-1">
                    <AlertCircle className="h-4 w-4" />
                    <span>{errors.duration}</span>
                  </p>
                ) : (
                  <p id="duration-help" className="mt-1 text-x-small text-neutral-gray">
                    Format: 5m, 12m, etc.
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-neutral-gray/20 border border-neutral-gray/30 rounded-lg text-text-light focus:outline-none focus:border-accent-yellow focus:ring-2 focus:ring-accent-yellow/20"
                  >
                ...
                <div>
                  <label htmlFor="difficulty" className="block text-small font-medium text-text-light mb-2">
                    Difficulty
                  </label>
                  <select
                    id="difficulty"
              ...
              <div>
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    className="w-5 h-5 text-accent-yellow bg-neutral-gray/20 border-neutral-gray/30 rounded focus:ring-accent-yellow/20 focus:ring-2"
                  />
                  <div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-h3 text-text-light mb-4 flex items-center space-x-2">
                ...
                {/* Thumbnail Preview */}
                <div className="mb-6">
                  <h4 className="text-body font-medium text-text-light mb-2">Thumbnail</h4>
                  <div className="w-full h-48 bg-neutral-gray/20 rounded-lg overflow-hidden border border-neutral-gray/30">
                    {formData.thumbnailUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-neutral-gray">
                        <div className="text-center">
                          <Eye className="h-8 w-8 mx-auto mb-2 opacity-50" />
                          <p className="text-small">Thumbnail preview</p>
                        </div>
                      </div>
                    )}
                  </div>
                  {previewError && (
                    <p className="mt-2 text-small text-red-400 flex items-center space-x-1">
                      <AlertCircle className="h-4 w-4" />
                ...
                {/* Video Preview */}
                <div className="mb-6">
                  <h4 className="text-body font-medium text-text-light mb-2">Video</h4>
                    ...
                    {formData.videoUrl && formData.videoUrl.includes('youtube-nocookie.com') ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-neutral-gray">
                        <div className="text-center">
                          ...
                          <p className="text-small">Video preview</p>
                          <p className="text-x-small mt-1">Enter a valid YouTube nocookie URL</p>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-neutral-gray/10 rounded-lg p-4">
                  <h4 className="text-body font-medium text-text-light mb-3">Course Card Preview</h4>
                  <div className="space-y-2">
                    <h5 className="text-body font-semibold text-text-light line-clamp-2">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-x-small text-text-light">
                          {formData.difficulty}
                        </span>
                      </div>
                      <span className="text-x-small text-text-light">
          ...
          {/* Footer */}
          <div className="flex items-center justify-end space-x-4 pt-6 mt-6 border-t border-neutral-gray/20">
            <button
              type="button"
              onClick={onClose}
              disabled={isSubmitting}
              className="px-6 py-3 border border-neutral-gray/30 text-text-light rounded-lg text-body font-medium hover:bg-neutral-gray/20 transition-all disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isSubmitting}
              className="bg-accent-purple text-text-dark px-6 py-3 rounded-lg text-body font-medium hover:bg-accent-deep-purple transition-all shadow-button disabled:opacity-50 flex items-center space-x-2"
            >
              {isSubmitting ? (
                <>
