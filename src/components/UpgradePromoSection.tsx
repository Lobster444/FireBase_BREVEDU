...
const UpgradePromoSection: React.FC<UpgradePromoSectionProps> = ({
  ...
  return (
    <section className="px-4 sm:px-padding-medium py-8 sm:py-12 bg-white">
      <div className="max-w-screen-2xl mx-auto">
        <div className="bg-gradient-to-r from-[#FF7A59]/10 to-[#F5C842]/10 rounded-[16px] p-6 sm:p-padding-large text-center border border-[#FF7A59]/20">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center justify-center mb-3 sm:mb-4">
              <Sparkles className="h-8 w-8 text-[#FF7A59] mr-3" />
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Upgrade to BrevEdu+</h2>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-4 sm:mb-6">
              <div className="flex items-center space-x-2 text-emerald-700">
                ...
                <span className="text-sm sm:text-base font-medium">Unlimited course access</span>
              </div>
              <div className="flex items-center space-x-2 text-emerald-700">
                <span className="text-base">✓</span>
                <span className="text-sm sm:text-base font-medium">3 daily AI practice sessions</span>
              </div>
              <div className="flex items-center space-x-2 text-emerald-700">
                <span className="text-base">✓</span>
                <span className="text-sm sm:text-base font-medium">Premium-only content</span>
              </div>
            </div>
            
            <PrimaryButton 
              onClick={onUpgradeClick}
              className="px-6 sm:px-8 py-3 sm:py-4 flex items-center justify-center space-x-2 mx-auto text-base sm:text-lg"
